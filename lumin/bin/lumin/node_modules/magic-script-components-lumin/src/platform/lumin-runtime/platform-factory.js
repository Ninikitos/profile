...
import { ui, TransformNode, ModelNode, Prism } from 'lumin';
...
class PlatformFactory extends NativeFactory {
  ...
  _removeChildNodeFromParentNode (parent, child) {
    ...
    } else if (parent instanceof ui.UiSlider) ; else if (parent instanceof ui.UiRectLayout) ; else if (parent instanceof ui.UiLinearLayout || parent instanceof ui.UiGridLayout) {
      if (child instanceof TransformNode) {
    ...
    } else if (parent instanceof ui.UiDropDownList) ; else if (parent instanceof ui.UiDialog) ; else if (parent instanceof ui.UiToggle) ; else if (parent instanceof ui.UiPanel) {
      if (child instanceof ui.UiPanel) {
        if (child.side !== undefined) ;
      } else {
        executor.callNativeAction(parent, 'removeChild', child);
      }
    } else if (parent instanceof ui.UiPortalIcon) ; else if (parent instanceof ui.UiPageView) {
      if (child instanceof TransformNode) {
