 ...
 */
const open = (path, flags, mode) => new Promise((resolve, reject) => fs.open(new Fs(), path, flags, mode, (error, fd) => error ? reject(error) : resolve(fd)));

/**
 * @param {number} fd
 * @returns {Promise<void>}
 */
const close = (fd) => new Promise((resolve, reject) => fs.close(new Fs(), fd, (error) => error ? reject(error) : resolve()));
 ...
 */
const read = (fd, buffer, position) => new Promise((resolve, reject) => fs.read(new Fs(), fd, buffer, position, (error, bytesRead) => error ? reject(error) : resolve(bytesRead)));
 ...
 */
const write = (fd, buffer, position) => new Promise((resolve, reject) => fs.write(new Fs(), fd, buffer, position, (error, bytesWritten) => error ? reject(error) : resolve(bytesWritten)));

/**
 * @param {number} fd
 * @returns {Promise<uv.StatEntry>}
 */
const fstat = (fd) => new Promise((resolve, reject) => fs.fstat(new Fs(), fd, (error, meta) => error ? reject(error) : resolve(meta)));
 ...
 * @returns {Promise<void>}
 */
const rename = (path, newPath) => new Promise((resolve, reject) => fs.rename(new Fs(), path, newPath, (error) => error ? reject(error) : resolve()));

/**
 * @param {string} path
 * @returns {Promise<void>}
 */
const unlink = (path) => new Promise((resolve, reject) => fs.unlink(new Fs(), path, (error) => error ? reject(error) : resolve()));
...
export { base64Decode, base64Encode, close, fstat, open, rawDecode, rawEncode, read, rename, unlink, utf8Decode, utf8Encode, utf8Length, write };
