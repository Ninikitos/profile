import { INVALID_RESOURCE_ID, ui } from 'lumin';
...
async function loadRemoteResource (url, properties, element, prism, setResourceFunctionName, createResourceFunction, postLoadAction) {
